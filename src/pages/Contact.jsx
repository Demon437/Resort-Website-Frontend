...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('✅ Enquiry submitted successfully! We will contact you within 24 hours.');
      resetForm();
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              {submitError && (
                <div className="bg-red-50 border-2 border-red-500 text-red-700 p-4 mb-6 animate-fade-in">
                  <div className="flex items-center space-x-2">
                    <span className="text-2xl">✕</span>
                    <div>
